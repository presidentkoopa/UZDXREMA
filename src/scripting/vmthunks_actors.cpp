...
// RS FORK -- real controller velocity (actor.h, "REAL controller velocity"),
...
DEFINE_FIELD(AActor, OffhandAngularVel)
...
DEFINE_FIELD(AActor, LaserHeadshotLinedUpMain)
DEFINE_FIELD(AActor, LaserHeadshotLinedUpOff)
...
DEFINE_FIELD(AActor, FollowBodyYaw)
DEFINE_FIELD(AActor, FollowBodyOfs)
DEFINE_FIELD(AActor, FollowHandMode)
DEFINE_FIELD(AActor, FollowHandOfs)
...
DEFINE_FIELD(AActor, FollowActorOfsCVar2)
